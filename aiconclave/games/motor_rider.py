    ...
    while True:
        try:
            ...
            if len(lmList) >= 16:
                ...
                left_distance, _, _ = pose_detector.findDistance(
                    left_elbow_coords,
                    left_wrist_coords,
                    img=img,
                    color=(0, 0, 255),
                ...
                right_distance, _, _ = pose_detector.findDistance(
                    right_elbow_coords,
                    right_wrist_coords,
                    img=img,
                    color=(0, 0, 255),
                ...
                put_text(
                    img,
                    f"(L, R) : {round(left_distance, 2), round(right_distance, 2)}",
                    (img.shape[1] - 450, 80),
                )
                put_text(
                    img,
                    f"Thresh (L, R) : {MR_LEFT_THRESHOLD, MR_RIGHT_THRESHOLD}",
                    (img.shape[1] - 450, 130),
                )
                ...
                if (
                    left_distance < MR_DOWN_THRESHOLD
                    and right_distance < MR_DOWN_THRESHOLD
                    and not down_key_pressed
                ):
                    pg.keyDown("down")
